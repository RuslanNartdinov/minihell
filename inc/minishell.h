...
void					add_to_env(t_shell *shell, char *string, int hide,
							int sethide);
...
void					add_token_from_checker(t_shell *shell, int type,
							char **string);
void					add_token_to_env(t_shell *shell);
int						check_env_dupes(t_shell *shell, char *string,
							int sethide);
...
void					bcomm_exec(t_command *cmd, t_shell *shell,
							t_child_params *params);
...
void					b_pwd(void);
void					b_exit(t_shell *shell, t_command *cmd,
							t_child_params *params);
